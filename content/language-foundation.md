...
Native dwarves have four arms and two legs. Digit count, detailed speech anatomy and several reproductive measurements remain open. The preferred provisional reproductive model is an actual egg within a parent-built porous mineral nursery, followed by a dependent hatchling. Language distinguishes the egg, its shell, the constructed casing and the whole nursery. It does not turn a natural quartz geode into an egg or presume all rock is nutritious or harmless.
...
These affixes are productive constructions, not guarantees that every combination has an established conventional sense. The verb database specifies permitted senses and argument roles. Kelir is a lexicalized habitat-participant extension: it does not require an invented verb meaning 'to kel'. A new term's literal reading, intended reference and example are recorded before it joins the shared dictionary. Literal language still allows humor, figurative speech and semantic change; the reference edition simply avoids making opaque metaphor the default naming method.

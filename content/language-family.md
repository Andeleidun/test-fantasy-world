...
3. Persistent barriers, divided drainage systems and discontinuous pass routes reduce contact. Five daughter traditions develop. Some routes later reconnect; borrowed words and mixed settlements do not erase every old difference.
...
| --- | --- | --- |
| Kamvar | no additional sound rule in this controlled model | men → men; kel → kel |
...
Only single consonants lenite in Dravvar and Solvar. A doubled consonant protects the cluster: sette does not become sedde merely because t is near vowels. The regular past suffix changes separately in Dravvar by analogy. The individual sound changes are plausible linguistic mechanisms; their exact combination and distribution here are artistic choices, not a prediction from climate or vocal anatomy.

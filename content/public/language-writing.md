...
Parentheses in technical writing group arithmetic expressions; spoken calculations say **op del** and **luk del**, open/close part, around a grouped expression. Grouped mathematical language is a conventional technical register, not an additional interpretation of every ordinary command to open a chamber. Very large magnitudes can use powers of ten expressed as repeated multiplication or written indexed powers; everyday readers are not assumed to use scientific notation fluently. Larger numbers follow the same grouping conventions.

...
Erde, Merenval and Dverghamar belong to **System A**, a wide three-star hierarchy. Each named primary world orbits a different local sun; Merenval's inhabited companion shares Merenval's sun. Erde's and Merenval's suns form the closer stellar pair, separated by a working distance near 80 astronomical units. Dverghamar's red sun travels around that pair at a working distance near 1,200 astronomical units.

This arrangement lets each world keep its own light, climate and calendar. The distant stars can still be prominent in local skies. On Dverghamar they provide almost no warmth, but they can remain useful to navigation and living rhythms on the dark hemisphere.

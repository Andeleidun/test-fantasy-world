...
Record keepers, craft schools and exchange settlements support the standard without requiring a single planetary state. Mechanical transport, rail, signal links and apprenticeship broaden its use. Local languages remain important in homes and communities.
...
Only single consonants lenite in Dravvar and Solvar. A doubled consonant protects the cluster: sette does not become sedde merely because t is near vowels. The regular past suffix changes separately in Dravvar by analogy. The individual sound changes are plausible linguistic mechanisms; their exact combination and distribution here are artistic choices, not a necessary consequence of climate or vocal anatomy.
...
These parallel passages show the same content in each language:

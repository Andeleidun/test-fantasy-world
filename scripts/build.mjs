...
// Preserve old map URLs with the public artwork, not the authorial comparison sheets.
for (const map of maps) if (map.legacyStem) await cp(`assets/maps/${map.stem}.svg`, resolve(out, `assets/maps/${map.legacyStem}.svg`));
...
const worlds = `<div class="world-cards"><a class="world-card erde" href="erde.html"><div class="world-art" aria-hidden="true"><div class="orb erde-orb"></div><span class="orbit"></span></div><span class="eyebrow">01 / The human world</span><h2>Erde</h2><p>Continental landscapes and the long, independent histories of Humans, Halflings and Goblins.</p><span class="card-action">Read about Erde <span aria-hidden="true">→</span></span></a><a class="world-card dverghamar" href="dverghamar.html"><div class="world-art" aria-hidden="true"><div class="orb dwarf-orb"></div><span class="orbit"></span></div><span class="eyebrow">02 / The twilight world</span><h2>Dverghamar</h2><p>Permanent day and night, with Dwarves, Trolls and Giants in fragmented refuge landscapes.</p><span class="card-action">Read about Dverghamar <span aria-hidden="true">→</span></span></a><a class="world-card merenval" href="merenval.html"><div class="world-art" aria-hidden="true"><div class="orb merenval-orb"></div><span class="companion-orb"></span><span class="orbit"></span></div><span class="eyebrow">03 / The paired worlds</span><h2>Merenval</h2><p>A water-rich Elven world and its inhabited companion, home also to Gnomes and Orcs.</p><span class="card-action">Read about Merenval <span aria-hidden="true">→</span></span></a></div>`;
await emit('index', layout('World guide', 'home', `${intro('World guide', 'Erde, Dverghamar & Merenval', 'A guide to the geography, living communities, languages and cosmology of the inhabited worlds, including Merenval’s close companion. Choose a world for an introduction, or browse a subject below.')}${worlds}<section class="section-block" aria-labelledby="explore-title"><div class="section-heading"><h2 id="explore-title">Browse by subject</h2></div><div class="entry-grid">${['elves','stellar-system-reference','magic','otherworld','korvar'].map(id => card(catalog.find(p => p.id === id))).join('')}</div></section><aside class="note"><strong>Reading the setting</strong><p>Physical values are labeled where they remain scenario targets. The selected system architecture, planetary chronologies and biological models retain their unresolved gates.</p><a href="about.html">About this guide <span aria-hidden="true">→</span></a></aside>`));

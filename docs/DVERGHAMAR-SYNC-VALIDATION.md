...
System A's shared age is selected at approximately 4.54 billion years, preserving Erde's chronology and adapting Dverghamar's earlier history. The current linked screening case uses a 0.50-solar-mass slow-rotating early-M star with about 0.0379 solar luminosities; 1.20 Earth bolometric flux at 0.1776 AU; and a 38.65-day orbital and synchronous period. It also defines a dry 1.50-bar atmospheric input and records the derived gravity, escape speed, column mass, total atmospheric mass and scale height. The values are conditional model inputs, not a completed stellar track, escape history or climate solution.
